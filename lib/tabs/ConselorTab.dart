...
class conselorTab extends StatefulWidget {
  const conselorTab({Key? key,}) : super(key: key);

  @override
  State<conselorTab> createState() => _conselorTabState();
}

enum FilterStatus { Pending, Approved, }
...
class _conselorTabState extends State<conselorTab> {
