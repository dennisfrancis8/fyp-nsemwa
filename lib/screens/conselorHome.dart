...
import '../tabs/ConselorTab.dart';
import '../tabs/homeTab.dart';
import '../tabs/scheduleTab.dart';

class conselorHome extends StatefulWidget {
  const conselorHome({Key? key}) : super(key: key);

  @override
  _conselorHomeState createState() => _conselorHomeState();
}
...
class _conselorHomeState extends State<conselorHome> {
